            ...
            <div class="col-md-12 container-fluid">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span><i class="fa"></i>Adicionar Funcionário</h3>
                    </div>
                    <div class="panel-body">
                        <form id="add_funcionario" method="POST">
                            <div class="row">
